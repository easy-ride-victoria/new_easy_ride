  ...
  return (
    <Formik
      ...
      validationSchema={Yup.object({
        ...
        horse: Yup.string().required("Required"),
        activity_date: Yup.string().required("Required"),
      })}
      onSubmit={(values, { setSubmitting }) => {
        Axios.post("/api/v1/reports", values).then(() => {
          console.log("sent!");
          setTimeout(() => {
            alert("Thank You!");
            setSubmitting(false);
    ...
    >
      <Container maxWidth="sm">
        <Form>
          ...
          <StyledInputLabel htmlFor="activity_date">
            {" "}
            Date of your ride or other activity
          </StyledInputLabel>
          ...
          <StyledInputLabel htmlFor="answer2">
            {" "}
            Select the type of activity you did on that occasion
          </StyledInputLabel>
          <Field
            name="answer2"
            as="select"
            style={stylesInputField}
            className="answer2"
          >
          ...
          <StyledInputLabel htmlFor="answer3">
            Please detail the exercises you worked on:
          </StyledInputLabel>
          <Field name="answer3" style={stylesTextArea} type="text" />
          <ErrorMessage name="answer3" />

          <StyledInputLabel htmlFor="answer4">
            Any other comment you feel are relevant?
          </StyledInputLabel>
